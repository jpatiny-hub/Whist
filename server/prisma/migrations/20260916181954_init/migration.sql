...
CREATE TABLE "HandDeclaration" (
    ...
    CONSTRAINT "HandDeclaration_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "HandDeclarationPlayer" (
    ...
    CONSTRAINT "HandDeclarationPlayer_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "HandPlayerScore" (
    ...
    CONSTRAINT "HandPlayerScore_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Player" ADD CONSTRAINT "Player_accountUserId_fkey" FOREIGN KEY ("accountUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Hand" ADD CONSTRAINT "Hand_dealerId_fkey" FOREIGN KEY ("dealerId") REFERENCES "Player"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandDeclaration" ADD CONSTRAINT "HandDeclaration_handId_fkey" FOREIGN KEY ("handId") REFERENCES "Hand"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandDeclarationPlayer" ADD CONSTRAINT "HandDeclarationPlayer_handDeclarationId_fkey" FOREIGN KEY ("handDeclarationId") REFERENCES "HandDeclaration"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandDeclarationPlayer" ADD CONSTRAINT "HandDeclarationPlayer_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "Player"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandPlayerScore" ADD CONSTRAINT "HandPlayerScore_handId_fkey" FOREIGN KEY ("handId") REFERENCES "Hand"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandPlayerScore" ADD CONSTRAINT "HandPlayerScore_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "Player"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
